...
int main() {
    ...
    while (choice != 7) {
        ...
        if (choice < 1 || choice > 7) {
            cout << "Error: Please enter a valid menu option (1-7)." << endl;
            continue;
        }
        ...
        switch (choice) {
            ...
            case 5: {
                int intRes;
                if (modulus(static_cast<int>(num1), static_cast<int>(num2), intRes)) {
                    cout << "Result: " << static_cast<int>(num1) << " % " << static_cast<int>(num2) << " = " << intRes << endl;
                } else {
                    cout << "Error: Cannot divide by zero." << endl;
                }
                break;
